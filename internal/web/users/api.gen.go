...
type PatchUserByIdJSONRequestBody = UserPatch
...
type ServerInterface interface {
	...
	// Delete user by id
	// (DELETE /users/{id})
	DeleteUserById(ctx echo.Context, id uint64) error
	// Patch user by id
	// (PATCH /users/{id})
	PatchUserById(ctx echo.Context, id uint64) error
}
...
func (sh *strictHandler) DeleteUserById(ctx echo.Context, id uint64) error {
...
func (sh *strictHandler) PatchUserById(ctx echo.Context, id uint64) error {
